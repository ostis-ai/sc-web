...
scgViewerWindow.prototype={_initWindow:function(a){this.domContainer=a.container;this._currentLanguage=this.renderer=null},receiveData:function(a){if(a=this._buildGraph(a)){$("#"+this.domContainer).empty();this.renderer=new scgKineticRenderer({graph:a,container:this.domContainer,width:800,height:600});var b=new scgLayout({});b.setGraph(a);b.setRenderer(this.renderer);b.layout();this.renderer.render()}else console.warn("Build graph error")},_buildGraph:function(a){return GraphBuilder.buildGraph(a)},
