...
scgViewerWindow.prototype={_initWindow:function(a){this.domContainer=a.container;this.renderer=null},receiveData:function(a){if(a=this._buildGraph(a)){$("#"+this.domContainer).empty();this.renderer=new scgKineticRenderer({graph:a,container:this.domContainer,width:800,height:600});var b=new scgLayout({});b.setGraph(a);b.setRenderer(this.renderer);b.layout();this.renderer.render()}else console.warn("Build graph error")},translateIdentifiers:function(){console.log("scgViewer translate event",this)},
_buildGraph:function(a){return GraphBuilder.buildGraph(a)}};SCgComponent={type:0,outputLang:"format_scg_json",factory:function(a){return new scgViewerWindow(a)}};$(document).ready(function(){SCWeb.core.ComponentManager.appendComponentInitialize(function(){SCWeb.core.ComponentManager.registerComponent(SCgComponent)})});var scArc=function(a,b,c){this._initScArc(a,b,c)};
